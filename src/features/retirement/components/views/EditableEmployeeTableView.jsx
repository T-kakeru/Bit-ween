...
// EditableEmployeeTable 縺ｮ陦ｨ遉ｺ雋ｬ蜍呻ｼ・iew・・
...
const EditableEmployeeTableView = ({
  ...
  const getSortIcon = (key) => {
    ...
    if (sort.direction === "asc") return "笆ｲ";
    if (sort.direction === "desc") return "笆ｼ";
    return null;
  };
  ...
  return (
    <div className="manager-table-area">
      <div className="manager-table-toolbar">
        ...
        >
          <span className="manager-filter-icon">笵・/span>
          邨槭ｊ霎ｼ縺ｿ
        </Button>
      ...
      <TableContainer className="manager-table-wrap" role="region" aria-label="遉ｾ蜩｡荳隕ｧ">
