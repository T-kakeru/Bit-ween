// 記事画面の「親情報」（入口状態）を管理する。

import { useCallback, useMemo, useState } from "react";
import { DEFAULT_ARTICLE_FILTER_ID } from "../logic/articleFilters";
...
const useArticleEntryParentInfo = ({ setActiveNav, setIsSidebarOpen }) => {
...
export default useArticleEntryParentInfo;
