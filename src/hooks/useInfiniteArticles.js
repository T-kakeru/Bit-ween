...
/**
 * 記事の無限スクロール取得をまとめたカスタムフック。
 * - Google系APIの nextPageToken / pageToken を使ったカーソル方式を想定
 * - API未設定時はモックデータを段階表示してフェールセーフ
 * - IntersectionObserver で画面下端付近を検知して自動で追加取得
 */
export const useInfiniteArticles = ({
  ...
  // 次ページ取得（API: nextPageToken、モック: slice）
